...
const KycDetails = (props) => {
    ...
    return (
        <div style={{ backgroundColor: 'white', width: '25rem', height: '31rem', borderRadius: '0.4rem', margin: '1rem', boxShadow: '-1px 2px 6px -2px rgba(0,0,0,0.27)' }}>
            ...
            <ListCell name='Marital Status' value={props.LoanApp.kycMaritalStatus} />
            ...
            <ListCell name='Employment Type' value={props.LoanApp.employmentType} />
            <ListCell name='Monthly Income' value={'₹' + props.LoanApp.monthlyIncome} />
            <ListCell name='Father Name' value={props.LoanApp.kycFatherSpouseName} />
