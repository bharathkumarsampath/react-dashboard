    ...
    return (
        <div style={{ backgroundColor: 'rgb(245,247,251)', textAlign: 'center', padding: '10rem' }}>
            ...
            <Typography style={{
                ...
                Data not loaded due to some server error
            </Typography>
            <Typography style={{
                width: '107px',
                height: '19px',
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" style={{ width: '48px', height: '48px', cursor: 'pointer' }} onClick={props.reload}>
...
export default TableServerError;
