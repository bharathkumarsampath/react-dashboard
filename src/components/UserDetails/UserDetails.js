...
const LoanDetails = (props) => {
    ...
    return (
        <div>
            ...
            <PennyDropCheckModal open={open} setOpen={setOpen} loanApp={props.LoanApp.loanApplicationNo} />
            <NsdlCheckModal open={nsdlModalopen} setOpen={setNsdlModalOpen} loanApp={props.LoanApp.loanApplicationNo} />
